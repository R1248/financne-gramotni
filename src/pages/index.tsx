...
export default function Home() {
  return (
    <>
      ...
      <main className="min-w-screen flex h-screen min-h-screen flex-col justify-stretch bg-[#264474] px-10 pb-5">
        ...
        <div className="my-3 flex w-full flex-grow">
          <div className="mr-3 flex h-full w-96 flex-col rounded-2xl bg-white">
            <h1 className="my-3 ml-3 text-3xl">Dominik Švancara</h1>
            <div className="mx-3 mb-3 flex flex-col border border-solid border-black p-3">
              <div className="mb-3 flex h-12 flex-col border border-solid border-black">
                <div className="flex flex-grow items-center">
                  ...
                  <p className="ml-auto mr-2 text-2xl">1 257 456 Kč</p>
                </div>
              ...
              <div className="mb-3 flex h-12 flex-col border border-solid border-black">
                <div className="flex flex-grow items-center">
                  ...
                  <p className="ml-auto mr-2 text-2xl">21</p>
            ...
            <div className="mx-3 mb-5 mt-auto flex flex-grow flex-col border border-solid border-black p-3 align-bottom">
              <h1 className="text-2xl">Portfolio</h1>
              <Portfolio />
            </div>
          </div>
          <div className="h-full flex-grow rounded-2xl bg-white"></div>
        </div>
