...
const HomePage: FC<HomePageProps> = ({ setRouter }) => {
  return (
    <div className="flex h-auto flex-grow rounded-2xl bg-white">
      <div className="flex h-full flex-col px-3 pb-9 pt-3">
        <LaptopImage setRouter={setRouter} buttonImage="personalFinance" />
      </div>
      ...
      <div className="ml-auto flex h-full flex-col justify-between px-3 pb-9 pt-3">
        ...
        <LaptopImage setRouter={setRouter} buttonImage="markets" />
      </div>
    </div>
  );
};
